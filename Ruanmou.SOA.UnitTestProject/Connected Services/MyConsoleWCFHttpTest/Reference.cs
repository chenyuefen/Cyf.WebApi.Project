...
namespace Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest {
    ...
    public interface IMathService {
        ...
        Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser GetUser(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/GetUser", ReplyAction="http://tempuri.org/IMathService/GetUserResponse")]
        System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser> GetUserAsync(int x, int y);
        ...
        Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser[] UserList();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/UserList", ReplyAction="http://tempuri.org/IMathService/UserListResponse")]
        System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser[]> UserListAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMathServiceChannel : Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.IMathService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MathServiceClient : System.ServiceModel.ClientBase<Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.IMathService>, Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.IMathService {
        ...
        public Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser GetUser(int x, int y) {
            return base.Channel.GetUser(x, y);
        }
        
        public System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser> GetUserAsync(int x, int y) {
            return base.Channel.GetUserAsync(x, y);
        }
        
        public Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser[] UserList() {
            return base.Channel.UserList();
        }
        
        public System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFHttpTest.WCFUser[]> UserListAsync() {
