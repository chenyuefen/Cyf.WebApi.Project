...
namespace Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest {
    ...
    public interface IMathService {
        ...
        Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser GetUser(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/GetUser", ReplyAction="http://tempuri.org/IMathService/GetUserResponse")]
        System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser> GetUserAsync(int x, int y);
        ...
        Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser[] UserList();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/UserList", ReplyAction="http://tempuri.org/IMathService/UserListResponse")]
        System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser[]> UserListAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMathServiceChannel : Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.IMathService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MathServiceClient : System.ServiceModel.ClientBase<Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.IMathService>, Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.IMathService {
        ...
        public Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser GetUser(int x, int y) {
            return base.Channel.GetUser(x, y);
        }
        
        public System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser> GetUserAsync(int x, int y) {
            return base.Channel.GetUserAsync(x, y);
        }
        
        public Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser[] UserList() {
            return base.Channel.UserList();
        }
        
        public System.Threading.Tasks.Task<Ruanmou.SOA.UnitTestProject.MyConsoleWCFTcpTest.WCFUser[]> UserListAsync() {
